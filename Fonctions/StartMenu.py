...
class StartMenu():
    ...
    def getmap(self):
        ...
        #             exit()
        #         elif ord(x) == 13:
        #             self.chosen = choice[self.selected]
        #             no_input = False
        ...
        #                 self.selected -= 1
        #             no_input = False
        #         elif x==ARROW_LEFT and self.file_index > 0:
        #             self.file_index -= 1
        #             no_input = False
        #         elif x==ARROW_RIGHT and self.file_index<len(directory_content)-1:
        #             self.file_index += 1
        #             no_input = False
        # if self.chosen == saved_maps and directory_content:
        #     self.chosen = directory_content[self.file_index]
        #     if os.path.exists(self.chosen):
        #         with open(self.chosen, "r") as maze_map:
